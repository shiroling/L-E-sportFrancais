...
public class CreerTournoi {
	...
	private void initialize() {
		...
		textDateDebut.setText("DD/MM/YYYY\r\n");
		...
		textDateFin.setText("DD/MM/YYYY");
		...
		texDateFinIscription.setText("DD/MM/YYYY");
			...
			public void actionPerformed(ActionEvent e) {
				for(int id : idJeux) {
					...
					if(idJeux.size() == 1) {
						...
						Tournoi.insererTournoi(textNom.getText() + "_" + j.getNomJeu(), comboPortee.getSelectedItem().toString(), texDateFinIscription.getText(), textDateDebut.getText(), textDateFin.getText(), id);
					}
				}
				CreerTournoi.fermer();
			}
